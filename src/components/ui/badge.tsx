...
const badgeVariants = cva(
  "inline-flex items-center px-2 py-0.5 font-display text-[11px] font-bold uppercase tracking-widest transition-colors",
  {
    variants: {
      variant: {
        default:
          "border border-[var(--neon)] bg-[var(--neon-dim)] text-[var(--neon)] shadow-[0_0_8px_rgba(79,246,128,0.2)]",
        secondary:
