    ...
    <div className="space-y-8 pb-8">
        ...
        {[
          {
            ...
            glow: pnlPositive ? "rgba(0,255,102,0.5)" : "rgba(255,58,110,0.5)",
          },
          {
            icon: Swords,
            label: "Win Rate",
            ...
            glow: winRate >= 50 ? "rgba(0,255,102,0.5)" : "rgba(255,58,110,0.5)",
          },
          {
            icon: BarChart3,
      ...
      <div className="grid grid-cols-3 gap-3">
          ...
          {streakType ? (
            <>
              <div className="font-mono text-3xl font-bold"
                style={{ color: streakType === "W" ? "var(--neon)" : "var(--danger)", textShadow: streakType === "W" ? "0 0 15px rgba(0,255,102,0.5)" : "0 0 15px rgba(255,58,110,0.5)" }}>
                {streak}×
              </div>
        ...
        <div className="bracket border border-[var(--border)] bg-[var(--surface-2)] p-4 text-center">
          ...
          <div className="font-mono text-2xl font-bold text-[var(--neon)]" style={{ textShadow: "0 0 12px rgba(0,255,102,0.4)" }}>
                  ...
                  <div className="h-1 bg-[var(--surface-1)] rounded-full overflow-hidden">
                    <div
                      ...
                      style={{
                        ...
                        boxShadow: wr >= 50 ? "0 0 6px rgba(0,255,102,0.5)" : "0 0 6px rgba(255,58,110,0.5)",
                      }}
                    />
                  </div>
                </div>
